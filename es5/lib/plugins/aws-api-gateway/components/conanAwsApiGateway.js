...
var _conanAwsApiGatewayStageJs = require("./conanAwsApiGatewayStage.js");

var _conanAwsApiGatewayStageJs2 = _interopRequireDefault(_conanAwsApiGatewayStageJs);
...
var ConanAwsApiGateway = (function (_ConanComponent) {
	...
	function ConanAwsApiGateway() {
		...
		_get(Object.getPrototypeOf(ConanAwsApiGateway.prototype), "constructor", this).apply(this, arguments);
	}
	...
	_createClass(ConanAwsApiGateway, [{
		...
		value: function stage(name) {
			return new _conanAwsApiGatewayStageJs2["default"](this.conan, name);
		}
	}, {
		key: "api",
